...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.DiscountShop_Cart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("DiscountedShopId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DiscountedShopId");

                    b.HasIndex("ShoppingCartItemId");

                    b.HasIndex("ShoppingVoucherUserid");

                    b.ToTable("DiscountShop_Cart");
                });

            modelBuilder.Entity("Domain.DiscountedShop", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Domain.Movie", b =>
                {
                    ...
                    b.Property<int>("TotalReturnedProducts")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.MovieNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Domain.MovieOutOfStock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("UserAttemptToCartOutOfStockId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("UserAttemptToCartOutOfStockId");

                    b.ToTable("MovieOutOfStocks");
                });

            modelBuilder.Entity("Domain.MovieOutOfStockNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("MovieOutOfStockId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MovieOutOfStockId");

                    b.HasIndex("ReceivingUserId");

                    b.ToTable("MovieOutOfStockNotifications");
                });
            ...
            modelBuilder.Entity("Domain.ShoppingCartItem", b =>
                {
                    ...
                    b.Property<bool>("IsMinimumQuota")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Domain.DiscountShop_Cart", b =>
                {
                    b.HasOne("Domain.DiscountedShop", "DiscountedShop")
                        .WithMany("DiscountShop_Carts")
                        .HasForeignKey("DiscountedShopId")
            ...
            modelBuilder.Entity("Domain.MovieOutOfStock", b =>
                {
                    ...
                    b.HasOne("Domain.ApplicationUser", "UserAttemptToCartOutOfStock")
                        .WithMany()
                        .HasForeignKey("UserAttemptToCartOutOfStockId");
                });

            modelBuilder.Entity("Domain.MovieOutOfStockNotification", b =>
                {
                    b.HasOne("Domain.MovieOutOfStock", "MovieOutOfStock")
                        .WithMany("MovieOutOfStockNotifications")
                        .HasForeignKey("MovieOutOfStockId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
